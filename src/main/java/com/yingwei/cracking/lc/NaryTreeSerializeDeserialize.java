 ...
 * For example, the above tree may be serialized as [1,null,3,2,4,null,5,6,null,null,null]
 * You do not necessarily need to follow the above suggested formats, there are many more different formats that work so please be creative and come up
